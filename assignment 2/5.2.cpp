...
int main() {
    ...
    int size = n * (n + 1) / 2; // number of elements in lower triangle so that only neccessary is stored like in n=4 insted of 16 only 10 elements are stored to save space
    int arr[size];
